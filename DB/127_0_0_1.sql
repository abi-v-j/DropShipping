...
--
CREATE DATABASE IF NOT EXISTS `db_dropshipping` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_dropshipping`;
...
--
CREATE DATABASE IF NOT EXISTS `db_mini_project` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_mini_project`;
...
CREATE TABLE `tbl_complaint` (
  ...
  `complain_status` int(11) NOT NULL DEFAULT 0,
...
INSERT INTO `tbl_complaint` (`complaint_id`, `complaint_date`, `complaint_details`, `complain_status`, `complaint_reply`) VALUES
(1, '', 'jhkjhkdushykuuiyuiuyuyru6r', 0, '');
...
INSERT INTO `tbl_product` (`product_id`, `product_name`, `product_details`, `product_image`, `product_price`) VALUES
(1, 'fffyt', '', 'Screenshot (1).png', 0),
(2, 'fffyt', 'hfyytuyr', 'Screenshot (1).png', 0);
...
CREATE TABLE `tbl_review` (
  ...
  `review_details` varchar(300) NOT NULL,
  `product_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `tbl_review` (`review_id`, `review_name`, `review_count`, `review_details`, `product_id`) VALUES
(1, '', 0, 'oiuoe', 0);
...
INSERT INTO `tbl_user` (`user_id`, `user_name`, `user_contact`, `user_email`, `user_password`, `user_image`, `user_address`, `place_id`) VALUES
(1, 'suhail', '8203892083', 'muhammedsuhail@gmail.com', '', 'Screenshot (1).png', 'aramthoppil house', 0),
(2, 'suhail', '98479588239', 'suhailch@gmail.com', '98479582', 'Screenshot (1).png', 'house angamaly', 3),
(3, 'suhail', '98479588239', 'suhailch@gmail.com', '98479582', 'Screenshot (1).png', 'house angamaly', 3),
(4, 'suhail', '8203892083', 'suhailch@gmail.com', 'suhailch', '', 'house angamaly', 3);
...
--
ALTER TABLE `tbl_place`
  MODIFY `place_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
('root', '[{\"db\":\"db_dropshipping\",\"table\":\"tbl_admin\"},{\"db\":\"db_dropshipping\",\"table\":\"tbl_seller\"},{\"db\":\"db_dropshipping\",\"table\":\"tbl_user\"},{\"db\":\"db_dropshipping\",\"table\":\"tbl_subcategory\"},{\"db\":\"db_dropshipping\",\"table\":\"tbl_review\"},{\"db\":\"db_dropshipping\",\"table\":\"tbl_product\"},{\"db\":\"db_dropshipping\",\"table\":\"tbl_place\"},{\"db\":\"db_dropshipping\",\"table\":\"tbl_district\"},{\"db\":\"db_dropshipping\",\"table\":\"tbl_complainttype\"},{\"db\":\"db_dropshipping\",\"table\":\"tbl_complaint\"}]');
...
('root', '2023-10-17 10:23:50', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":249}');
