                            ...
                            <div class="card-deck">
                                <div class="card border-secondary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title text-danger" align="center">
                                           Max Price : <?php echo $rowS["product_maxprice"]; ?>/-
                                        </h4>
                                        <p align="center">
									...
									?>
                                        <a href="javascript:void(0)" onclick="addCart(<?php echo $rowS['product_id']; ?>,<?php echo $rowS['product_maxprice']; ?>)" class="btn btn-success btn-block">Add to Cart</a>
