...
<br><br><br><br><br><br>
<?php
	$selQry = "select * from tbl_booking b inner join tbl_cart c on c.booking_id = b.booking_id inner join  tbl_product p on p.product_id = c.product_id inner join  tbl_seller s on s.seller_id = c.seller_id where user_id='" . $_SESSION["uid"] . "' and booking_status>0 and booking_status<9 and cart_status>0 and cart_status<9";
			...
			<form id="form1" name="form1" method="post" action="">
				<table border="1">
					...
					while ($row = $res->fetch_assoc()) {
						...
						$totalamount = $row['booking_amount'];
						$i++;
