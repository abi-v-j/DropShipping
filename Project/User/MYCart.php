...
if (isset($_POST["btn_checkout"])) {
    ...
    if ($Conn->query($upQry1)) {
        ...
        if (isset($_POST["cb_checkout"])) {
            ...
            $a = "update tbl_booking set booking_status='2' where booking_id='" .$row["booking_id"] . "'";
            if ($Conn->query($a)) {
                    ...
                    if ($rowpr = $respr->fetch_assoc()) {
                        ...
                        <div class="product">
                            ...
                            <div class="product-quantity">
                                <input id="<?php echo $row["cart_id"] ?>" type="number"
                                    value="<?php echo $row["cart_quantity"] ?>" min="1" />
                            </div>
