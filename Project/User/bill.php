...
$selqry="select * from tbl_cart c inner join tbl_booking b on b.booking_id=c.booking_id inner join tbl_user u on u.user_id=b.user_id inner join tbl_product p on p.product_id=c.product_id inner join tbl_seller k on k.seller_id=c.seller_id where c.cart_id='".$_GET["id"]."'";
        ...
        <table style="width: 100%; table-layout: fixed">
          <tr>
            ...
            >
              ...
              >
              	<span
                style="color:#F93;font-size:56px">DropShipping</span>
