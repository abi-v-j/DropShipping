...
<br><br><br><br><br>
<?php
$selQry="select *from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id inner join tbl_product p on p.product_id=c.product_id where c.seller_id='".$_SESSION["sid"]."' and b.booking_status!='0' and b.booking_status < '9' and c.cart_status !='0' and c.cart_status<'9'";
