...
<html>
    ...
    <?php
        ...
        if (isset($_POST["btn_checkout"])) {
                ...
                $selC = "select * from tbl_booking where seller_id='" .$_SESSION["sid"]. "'and booking_status='0'";
                $rs = $Conn->query($selC);
                $row=$rs->fetch_assoc();
                
                $upQry1 = "update tbl_booking set booking_date=curdate(),booking_status='10' where seller_id='" .$_SESSION["sid"]. "'";
				$Conn->query($upQry1);
				
				 $upQry1 = "update tbl_cart set cart_status='10' where booking_id='" .$row["booking_id"]. "'";
    ...
    <div style="padding: 30px;" align="center">
        ...
        <br>
            <div class="column-labels">
                <label class="product-price" style="width: 20%; text-align:center">Image</label>
                <label class="product-price" style="width: 20%; text-align:center">Details</label>	
                <label class="product-price" style="width: 16%; text-align:center">Price</label>
                <label class="product-price" style="width: 16%; text-align:center">Added Price</label>
                <label class="product-price" style="width: 16%; text-align:center">Remove</label>
            </div>
<form method="post">
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
            $sel = "select * from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id where c.seller_id='" .$_SESSION["sid"]. "' and booking_status='0' and cart_status=0";
            $res = $Conn->query($sel);
            ...
            ?>
                ...
                <button type="submit" class="checkout" name="btn_checkout">Click To Add Product</button>
